...
## PassJava-Platform 面试刷题项目-部署教程

可落地的 Spring Cloud项目：`PassJava-Platform` https://github.com/Jackson0714/PassJava-Platform
...
- PassJava-Platform 是一款Java`面试刷题`的开源系统，可以用零碎时间利用小程序查看常见面试题，夯实Java基础。
