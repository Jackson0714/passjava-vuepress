...
![Jenkins 打包部署原理图](http://cdn.passjava.cn/uPic/image-20230602144613432qHTnRM.png)
...
![Jenkins配置入口](http://cdn.passjava.cn/uPic/image-202305241057155160h0yGo.png)

![Jenkins Global Tool Configuration](http://cdn.passjava.cn/uPic/image-20230602151944065YwoHBz.png)
...
![全局属性配置](http://cdn.passjava.cn/uPic/image-202305241110221324rxTwP.png)
...
![](http://cdn.passjava.cn/uPic/image-202306021558022853s3tXO.png)

### 创建一个项目

![创建一个项目](http://cdn.passjava.cn/uPic/image-20230524112233219ynjuMm.png)

创建成功后就会出现一条记录：

![Dashboard 界面](http://cdn.passjava.cn/uPic/image-20230524112304729Fssp9z.png)
...
![配置拉取的代码仓库地址和认证方式](http://cdn.passjava.cn/uPic/image-20230602153507389jRwOoy.png)

#### 配置打包

![配置 Maven 打包](http://cdn.passjava.cn/uPic/image-20230602154515672D68iEp.png)
...
![打印 Jenkins 运行项目的结果](http://cdn.passjava.cn/uPic/image-20230614092829142P8eMSP.png)
...
![Jenkins 插件管理](http://cdn.passjava.cn/uPic/image-20230602162300732LNFcl5.png)
...
![配置远程服务器地址](http://cdn.passjava.cn/uPic/image-20230602164456545QfOXB3.png)
...
![备份服务器 JAR 包](http://cdn.passjava.cn/uPic/image-20230602163000610HDQQst.png)
...
![拷贝多个 JAR 包到远程服务器](http://cdn.passjava.cn/uPic/image-20230602163528221lAUAj7.png)
...
![配置远程执行脚本的命令](http://cdn.passjava.cn/uPic/image-202306140857359190g4xkJ.png)
...
![部署结果](http://cdn.passjava.cn/uPic/image-20230614091659535YK2j1w.png)
...
![问题 3 的记录](http://cdn.passjava.cn/uPic/image-20230614092542460VYEmWx.png)
...
![问题 3 的解决思路](http://cdn.passjava.cn/uPic/image-20230525092922185ugY99L.png)
...
![问题 4 解决思路](http://cdn.passjava.cn/uPic/image-20240706103719712gv4gyf.png)
...
![问题 5 的记录](http://cdn.passjava.cn/uPic/image-2023052616581789536i1CF.png)

解决方案：修改超时时间设置

![问题 5 的解决方案](http://cdn.passjava.cn/uPic/image-20230526170026313XsRNTM.png)
