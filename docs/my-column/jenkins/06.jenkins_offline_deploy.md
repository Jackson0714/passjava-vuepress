...
![](http://cdn.passjava.cn/uPic/image-20240604144750167RJqT7q.png)
...
![](http://cdn.passjava.cn/top/image-20240530092019367.png)

下载完是一个 war 包，后续用 Java 启动这个 war 包即可。

![](http://cdn.passjava.cn/top/image-20240604120332704.png)

## 四、安装 Java

### 下载 Java 17 安装包

![](http://cdn.passjava.cn/top/6974e776ea1c4e4e96ad6e720c503ec3.png)
...
![image-20240530093632568](http://cdn.passjava.cn/top/image-20240530093632568.png)
...
if [ "$1" = "start" ]; then
    if [ -n "$pid" ]; then
        ...
        nohup /usr/local/java17-oraclejdk/bin/java -Duser.timezone=Asia/Shanghai -jar /home/jenkins/jenkins.war --httpPort=8082 >nohup.out 2>&1 &
    fi
elif [ "$1" = "stop" ]; then
    exec ps -ef | grep jenkins.war | grep -v grep | awk '{print $2}' | xargs sudo kill -9
...
![](http://cdn.passjava.cn/uPic/image-2025061610404708164pZvq.png)
...
![](http://cdn.passjava.cn/top/image-20240530095716761.png)
...
![](http://cdn.passjava.cn/top/image-20240530100150409.png)
...
![image-20240530114234994](http://cdn.passjava.cn/top/image-20240530114234994.png)

该目录下有一个非常重要的目录：plugins，我们可以拷贝一些插件到这个目录里面，这样 jenkins 就可以启动这些插件了。

![](http://cdn.passjava.cn/top/image-20240530114304632.png)
...
![](http://cdn.passjava.cn/top/image-20240530123940685.png)
...
![](http://cdn.passjava.cn/top/image-20240530102511799.png)
...
![](http://cdn.passjava.cn/top/image-20240530104527453.png)
...
![](http://cdn.passjava.cn/top/image-20240530111902447.png)

![](http://cdn.passjava.cn/top/image-20240530111944354.png)
...
![](http://cdn.passjava.cn/top/image-20240530112743114.png)
...
![](http://cdn.passjava.cn/top/image-20240531151908351.png)
...
![](http://cdn.passjava.cn/top/image-20240604135636411.png)
...
![](http://cdn.passjava.cn/top/image-20240604135612268.png)
...
![image-20240604135520172](http://cdn.passjava.cn/top/image-20240604135520172.png)
...
![](http://cdn.passjava.cn/top/image-20240604135535251.png)
...
![](http://cdn.passjava.cn/top/image-20240531150504780.png)
...
![](http://cdn.passjava.cn/top/image-20240604131517908.png)
