...
![](http://cdn.passjava.cn/uPic/image-20220422095520435HkfFAu.png)

在启动这里选择 Edit Configurations 进行配置：

![](http://cdn.passjava.cn/uPic/image-20220422095746202d5983J.png)

然后复制三个 Nacos 配置，分别以 Nacos-8848、Nacos-8858、Nacos-8868 命名。

![](http://cdn.passjava.cn/uPic/image-20220422100136769uHJet9.png)

### IDEA 配置

![](http://cdn.passjava.cn/uPic/image-202204221002116617sRzch.png)
...
![](http://cdn.passjava.cn/uPic/image-202204220948029761uzljl.png)

### 启动 Nacos 集群环境

首先需要开启允许运行多个实例。点击 Edit Configurations 中，再点击 Modify Options，勾选 Allow mutiple instances，如下图所示：

![](http://cdn.passjava.cn/uPic/image-20220422100455993EA4mcd.png)

然后分别以 debug 模式启动这三个实例，如下图所示：

![](http://cdn.passjava.cn/uPic/image-202204221008010864fxRqZ.png)
