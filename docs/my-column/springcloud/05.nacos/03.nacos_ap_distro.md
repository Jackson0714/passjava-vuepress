---
title: Nacos 架构原理②：揭秘 AP 架构——Distro 一致性协议
date: 2024-08-18
---
...
![](http://cdn.passjava.cn/uPic/image-20220504113110811on9pa8.png)
...
![Nacos 集群节点](http://cdn.passjava.cn/uPic/image-20220427211513114ErcXkf.png)

![Nacos 集群环境](http://cdn.passjava.cn/uPic/image-20220427220632378nCoaA5.png)
...
![Distro 的设计机制](http://cdn.passjava.cn/uPic/image-20220504220127510ZudbpC.png)
...
![](http://cdn.passjava.cn/uPic/image-20220427075804426upuierjz3uG9.png)

上一讲我们已经说过，这里面会做几件事：

![添加实例信息的流程](http://cdn.passjava.cn/uPic/image-20220413164932907KHTvVMRZvHBS.png)
...
![添加任务到 map 中](http://cdn.passjava.cn/uPic/image-202204282252571448WDN2R.png)

代码时序图如下所示：

![sync 的核心代码时序图](http://cdn.passjava.cn/uPic/image-20220428225403541nvJwU7.png)
...
![Nacos 异步复制数据到其他节点的流程图](http://cdn.passjava.cn/uPic/image-20220428225545543RA3daf.png)
...
![存储注册信息的数据结构](http://cdn.passjava.cn/uPic/image-20220503170049038UscWkk.png)
...
![服务端处理注册请求的源码](http://cdn.passjava.cn/uPic/image-2022050317065873827D1kB.png)
...
![](http://cdn.passjava.cn/uPic/image-20220504202844197LC6a4x.png)
...
![](http://cdn.passjava.cn/uPic/image-202205042119409621211OU.png)
...
![读操作的原理](http://cdn.passjava.cn/uPic/image-20220504214633683iEtFAd.png)
