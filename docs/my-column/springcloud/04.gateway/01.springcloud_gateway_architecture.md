---
title: 深入理解 Spring Cloud Gateway 的原理
date: 2024-08-18
---
...
![](http://cdn.passjava.cn/uPic/image-202208012034415279Ux8PR.png)
...
![单体架构访问示例图](http://cdn.passjava.cn/uPic/image-20220722151639331vgGmCU.png)

但是在 SpringCloud 微服务架构中，往往有多个微服务，这些微服务可能部署在不同的机器上，而且一个微服务可能会扩容成多个相同的微服务，组成微服务集群。

![微服务架构访问示例图](http://cdn.passjava.cn/uPic/image-20220722151724632YUIUdM.png)
...
![](http://cdn.passjava.cn/uPic/image-202207221618036200lBE5V.png)
...
![](http://cdn.passjava.cn/uPic/image-20220801211318751WxbFi5.png)
...
![断言配置](http://cdn.passjava.cn/uPic/image-20220729101524184PHTw8U.png)

接下来我们看下 Route 路由和 Predicate 断言的对应关系：

![断言和路由的对应关系原理图](http://cdn.passjava.cn/uPic/image-20220801210759424f0bZBO.png)
...
![常见的 Predicate 断言配置](http://cdn.passjava.cn/uPic/image-20220729113029190p6cTvL.png)
...
![](http://cdn.passjava.cn/uPic/image-20220801094657631kdgBI0.png)
...
![](http://cdn.passjava.cn/uPic/image-20220801110621155zuFGRk.png)

对应的配置为 uri 字段如下所示

![](http://cdn.passjava.cn/uPic/image-202208011103029348e4usO.png)uri: lb://passjava-question，表示将请求转发给 passjava-question 微服务，且支持负载均衡。lb 是 loadbalance（负载均衡) 单词的缩写。
...
![](http://cdn.passjava.cn/uPic/BbhUgx6bs0xI9EoLKU.gif)
...
![](http://cdn.passjava.cn/uPic/image-20220801153546221F5Ja7c.png)
...
![](http://cdn.passjava.cn/uPic/image-20220801160759874YcDKvo.png)
...
![](http://cdn.passjava.cn/uPic/image-20220801210230668uBySXS.png)
...
![](http://cdn.passjava.cn/uPic/image-20220801210318573eErYgy.png)

- 测试 token 正确的场景。

然后测试在 header 中添加 token=admin，正常返回响应数据。

![](http://cdn.passjava.cn/uPic/image-20220801210356913onHBUx.png)
