...
- Java虚拟机机制屏蔽了底层运行平台的差别，实现了“一次编译，到处运行”。<img src="http://cdn.passjava.cn/uPic/20210127170556NIJcnA.jpg" style="zoom:67%;" />

  <img src="http://cdn.passjava.cn/uPic/20210127170603y7MYGK.jpg" style="zoom: 50%;" />
...
![](http://cdn.passjava.cn/uPic/20210127170613e6u6n6.jpg)

![](http://cdn.passjava.cn/uPic/20210127170618Wx1FrT.jpg)
...
- 在dos命令行中敲入javac，出现错误提示：<img src="../upload/BlogPicBed-1-master/img/2021/01/27/20210127170624.png" style="zoom: 67%;" />
- 错误原因：当前执行的程序在当前目录下如果不存在，windows系统会在系统中已有的一个名为path的环境变量指定的目录中查找。如果仍未找到，会出现以上的错误提示。所以进入到jdk安装路径\bin目录下，执行javac，会看到javac参数提示信息。<img src="../upload/BlogPicBed-1-master/img/2021/01/27/20210127170628.png" style="zoom:67%;" />
...
- 配置方法：
  ...
  - 注：具体操作流程，参看https://www.yuque.com/nizhegechouloudetuboshu/library/rc1889
    ![](http://cdn.passjava.cn/uPic/20210127170633TL2YAL.jpg)

> 6、验证是否成功

<img src="http://cdn.passjava.cn/uPic/202101271706397Vis0q.jpg" alt="图片" style="zoom:67%;" />

<img src="http://cdn.passjava.cn/uPic/20210127170642Cm9rie.jpg" alt="图片" style="zoom:67%;" />

<img src="http://cdn.passjava.cn/uPic/20210127170647TabB22.jpg" alt="图片" style="zoom:67%;" />
...
![图片](http://cdn.passjava.cn/uPic/20210127170653ct8k2S.jpg)
...
- 通过运行工具java.exe对字节码文件进行执行。
  ![](http://cdn.passjava.cn/uPic/20210127170702rQZD1D.jpg)
- 出现提示：缺少一个名称为main的方法。
  ![](http://cdn.passjava.cn/uPic/20210127170709DtNz43.jpg)
...
- 想要和JVM来个互动，只要在main方法中加入一句System.out.println(“Hello World");因为程序进行改动，所以再重新编译，运行即可。
  ![](http://cdn.passjava.cn/uPic/20210127170715cw0YUj.jpg)

# 07、 常见问题及解决方法

> 1、问题1

![](http://cdn.passjava.cn/uPic/20210127170721mJ8gEH.jpg)
...
![](http://cdn.passjava.cn/uPic/20210127170727J2jaGd.jpg)
...
![](http://cdn.passjava.cn/uPic/20210127170732J5JMYD.jpg)

- 声明为public的类应与文件名一致，否知编译失败

> 4、问题4

![](http://cdn.passjava.cn/uPic/20210127170739yrnAbN.jpg)
  ...
  - **文档注释(java特有)**
    ...
    - **格式**：
      ...
      **注释内容可以被JDK提供的工具javadoc所解析，生成一套以网页文件形式体现的该程序的说明文档。**
      ...
      ![](http://cdn.passjava.cn/uPic/20210127170744LvZBQy.jpg)
