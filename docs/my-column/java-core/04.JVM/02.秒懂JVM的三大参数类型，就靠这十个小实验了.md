---
title: 秒懂JVM的三大参数类型，就靠这十个小实验了
date: 2024-10-18
---

# 秒懂JVM的三大参数类型，就靠这十个小实验了

![封面](http://cdn.passjava.cn/blog/20200915/64RykjzQjHkQ.png?imageslim)
...
<img src="http://cdn.passjava.cn/blog/20200915/MV0FYJ4Yk4St.png?imageslim" alt="目录" style="zoom: 67%;" />
...
![实验 1-1](http://cdn.passjava.cn/blog/20200915/kh8gIaaDNWcO.png?imageslim)
...
![实验 1-2](http://cdn.passjava.cn/blog/20200915/LrdkQchIeA68.png?imageslim)
...
![实验 1-3](http://cdn.passjava.cn/blog/20200915/m071zNL09FWL.png?imageslim)
...
![实验 2-1](http://cdn.passjava.cn/blog/20200915/WilmN3z594lS.png?imageslim)
...
![实验 2-2](http://cdn.passjava.cn/blog/20200915/Vw6LnUFlAoV4.png?imageslim)
...
![实验 2-3](http://cdn.passjava.cn/blog/20200915/WfCWww8QPPey.png?imageslim)
...
![New File](http://cdn.passjava.cn/blog/20200915/LqSg8Wfv4Q0N.png?imageslim)

#### 创建文件名为 demoXXparam.java

![demoXXparam.java](http://cdn.passjava.cn/blog/20200915/l7S79mJGxMyW.png?imageslim)
...
![编译代码](http://cdn.passjava.cn/blog/20200915/LfePCqTuPfw8.png?imageslim)

编译之后，会在当前文件夹产生我们所编写的 `demoXXparam` 类的 `demoXXparam.class` 字节码文件

![生产Class文件](http://cdn.passjava.cn/blog/20200915/JHN788srztv4.png?imageslim)
...
![运行Java程序](http://cdn.passjava.cn/blog/20200915/nEMy2HVmtvn5.png?imageslim)
...
![开启新控制台窗口](http://cdn.passjava.cn/blog/20200915/EMXBB1AclsiR.png?imageslim)
...
![jps](http://cdn.passjava.cn/blog/20200915/Oyv9PTQLyn6F.png?imageslim)
...
![jinfo](http://cdn.passjava.cn/blog/20200915/omoVEe2GINuu.png?imageslim)
...
![实验 4](http://cdn.passjava.cn/blog/20200915/MOgivWNJrU2h.png?imageslim)
...
![进程 id](http://cdn.passjava.cn/blog/20200915/AnyM84Hm6ssL.png?imageslim)
...
![PrintGCDetails 参数](http://cdn.passjava.cn/blog/20200915/Aq86jo99LesY.png?imageslim)
...
![MetaspaceSize 大小](http://cdn.passjava.cn/blog/20200915/gnLKSvpUHs9u.png?imageslim)
...
![调整元空间大小](http://cdn.passjava.cn/blog/20200915/UkLaR8mWA3ci.png?imageslim)
...
![设置 InitialHeapSize](http://cdn.passjava.cn/blog/20200915/cFPq3SXFaYhj.png?imageslim)
...
![设置 MaxHeapSize](http://cdn.passjava.cn/blog/20200915/6gSgjOIrxPeQ.png?imageslim)
...
![mark](http://cdn.passjava.cn/blog/20200915/JvPXocfjcNrD.png?imageslim)
...
![PrintFlagsInitial](http://cdn.passjava.cn/blog/20200915/xpiHl2QULIbI.png?imageslim)
...
![PrintFlagsFinal](http://cdn.passjava.cn/blog/20200915/KWTbx4Qi0krm.png?imageslim)
...
![Global flags](http://cdn.passjava.cn/blog/20200915/UbnXulH9GdUa.png?imageslim)

- `:=`：参数已被修改，如下图所示InitialHeapSize初始化堆内存参数已修改为264241152

  总结如下：

![出厂设置和自定义参数设置](http://cdn.passjava.cn/blog/20200915/yWaE4B437bXk.png?imageslim)
...
![运行程序时打印XX配置选项](http://cdn.passjava.cn/blog/20200915/NQ6Q9szVKbvq.png?imageslim)
...
![JVM 自动配置的XX选项](http://cdn.passjava.cn/blog/20200915/sqztVGrgOkYm.png?imageslim)
