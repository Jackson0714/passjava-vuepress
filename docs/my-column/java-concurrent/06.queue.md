---
title: 干货 | 45张图庖丁解牛18种Queue，你知道几种？
---
...
![本篇主要内容](http://cdn.passjava.cn/uPic/ff538eb28fd24607b1420d58c008844d~tplv-k3u1fbpfcp-zoom-1ROW0gkTzDJzF.png)

**帮你总结好的阻塞队列：**

![18种Queue总结](http://cdn.passjava.cn/uPic/efef44bd0b44438e9cc127067adc97cc~tplv-k3u1fbpfcp-zoom-1sIEhRixLt7jo.png)

## 一、Queue自我介绍

![队列原理图](http://cdn.passjava.cn/uPic/301cc674be7d4ff98cd792dfbc7ae95a~tplv-k3u1fbpfcp-zoom-1iSHhp00Q8K4N.png)
...
![18个Queue的继承实现关系图](http://cdn.passjava.cn/uPic/db413964c91d4589a08a90645bd4be48~tplv-k3u1fbpfcp-zoom-1-20240420221210386OylASD.png)
...
![Queue的核心方法](http://cdn.passjava.cn/uPic/fd8ae2eeae7b44fa9642563d957e43a4~tplv-k3u1fbpfcp-zoom-1kwakFM.png)
...
![双端队列Deque](http://cdn.passjava.cn/uPic/94049f560e0d4f898726baa7e331f0c1~tplv-k3u1fbpfcp-zoom-1zX2qBY.png)
...
![示例代码](http://cdn.passjava.cn/uPic/54e135b9729f4521b480c5287d557f8b~tplv-k3u1fbpfcp-zoom-18tQv8g.png)
...
![AbstractQueue的方法](http://cdn.passjava.cn/uPic/6aa38f5e13214cbfa4c55d42fb2693ce~tplv-k3u1fbpfcp-zoom-1psOxTZ.png)
...
![阻塞队列满了的情况](http://cdn.passjava.cn/uPic/7fd405b131944763873c4002a38b314d~tplv-k3u1fbpfcp-zoom-1alioKg.png)

- BlockQueue为空，Take操作被阻塞

![阻塞队列为空的情况](http://cdn.passjava.cn/uPic/fe047cc4c2574eb481fe52e78f06311b~tplv-k3u1fbpfcp-zoom-1sb0W4u.png)
...
![继承的方法](http://cdn.passjava.cn/uPic/8cf7f40dcdd14ce3b18a88684246dac2~tplv-k3u1fbpfcp-zoom-1OoeL9z.png)

**10个核心方法总结如下：**

![BlockingQueue接口的10个核心方法](http://cdn.passjava.cn/uPic/d74aac30b47b44e8913dcdc9fb4e957f~tplv-k3u1fbpfcp-zoom-14KGRNU.png)
...
![BlockingDeque满了](http://cdn.passjava.cn/uPic/043d40182984482bb5efd0a6bcef7db2~tplv-k3u1fbpfcp-zoom-1gvsMux.png)

- BlockDeque 为空，两端的 Take 操作被阻塞

![BlockQueue为空](http://cdn.passjava.cn/uPic/49216b00b4f14786b86627e31ab527f3~tplv-k3u1fbpfcp-zoom-1XD3ew4.png)

### 7.2 BlockingDeque接口方法

是阻塞队列`BlockingQueue`和双向队列`Deque`接口的结合。有如下方法：

![BlockingDeque接口方法](http://cdn.passjava.cn/uPic/8b49f1885eed4f45b7acc144e7717d69~tplv-k3u1fbpfcp-zoom-14nVsD2.png)
...
![队列种的元素](http://cdn.passjava.cn/uPic/b59677d6dff24ef6abe9b4e3e86ac739~tplv-k3u1fbpfcp-zoom-1sFjCQC.png)

### 7.3 BlockDeque和BlockQueue的对等方法

![mark](http://cdn.passjava.cn/uPic/f8e5bc7789a649e5a2a44565558dc456~tplv-k3u1fbpfcp-zoom-1whQz0r.png)
...
- `transfer(E e)`
  ...
  ![transfer方法的原理](http://cdn.passjava.cn/uPic/579328b1b66646a7ac5b5e34fee780c9~tplv-k3u1fbpfcp-zoom-1ObIeXK.png)
...
![本应该按照升序排序](http://cdn.passjava.cn/uPic/dfa99505a54f40e999aef4b2f7c30ec5~tplv-k3u1fbpfcp-zoom-13AUUTh.png)

- 按照倒叙排序

![按照自定义优先级排序](http://cdn.passjava.cn/uPic/fab8b50f918547ea841c5b9be12c3f26~tplv-k3u1fbpfcp-zoom-1Nycfwm.png)
...
![LinkedList的结构](http://cdn.passjava.cn/uPic/eefebc6f82f0402ca7459d05ba8647b2~tplv-k3u1fbpfcp-zoom-13mbVtj.png)
...
![ConcurrentLinkedQueue原理](http://cdn.passjava.cn/uPic/3415cc52551948cd8fa0437336e8ddf0~tplv-k3u1fbpfcp-zoom-1v5zZNN.png)
...
![ArrayDeque原理图](http://cdn.passjava.cn/uPic/0cba13df8c18485b8b96cc2f655a8c46~tplv-k3u1fbpfcp-zoom-16fHxpn.png)
...
![ConcurrentLinkedDeque原理图](http://cdn.passjava.cn/uPic/78db2b7d59b843098cf9a3f25e012a8e~tplv-k3u1fbpfcp-zoom-1OTSVt1.png)
...
![ArrayBlockingQueuey原理图](http://cdn.passjava.cn/uPic/a16240718c9341a094ecc540bf04022a~tplv-k3u1fbpfcp-zoom-17tByud.png)
...
![LinkedBlockingQueue原理](http://cdn.passjava.cn/uPic/1ac7b1adc60541898c71255056128b56~tplv-k3u1fbpfcp-zoom-1yXh1WK.png)
...
![LinkedBlockingDeque原理图](http://cdn.passjava.cn/uPic/85565faed05943bb85abd1c624c00930~tplv-k3u1fbpfcp-zoom-1vGiler.png)
...
![LinkedTransferQueue原理图](http://cdn.passjava.cn/uPic/96ad695d5cac493a916a6752747078b8~tplv-k3u1fbpfcp-zoom-1qPQt9p.png)
...
![生产者1 依次往队列中添加 A、B、C](http://cdn.passjava.cn/uPic/c79401ed5ff546b68f56daace7c9c597~tplv-k3u1fbpfcp-zoom-15G70Qo.png)

- 生产者2 依次往队列中添加 D、E、F

![生产者2 依次往队列中添加 D、E、F](http://cdn.passjava.cn/uPic/2042217c4ef5411aab14d08d072876bb~tplv-k3u1fbpfcp-zoom-18d4g4I.png)

- 消费者依次从队列首部开始消费元素，每次消费前，先sleep 2s，来演示transfer方法是否进行了等待。

![消费者消费元素](http://cdn.passjava.cn/uPic/ef05c7c07ca842078f53ff5043245f24~tplv-k3u1fbpfcp-zoom-1MNvPV3.png)
...
![队列里面的元素](http://cdn.passjava.cn/uPic/9cb8b7ef299749138c7a3cdef584c845~tplv-k3u1fbpfcp-zoom-1mCLULh.png)
...
![SynchronousQueue原理图](http://cdn.passjava.cn/uPic/0ac2298fedd242019cfe75d7d4309833~tplv-k3u1fbpfcp-zoom-1n5XVv6.png)
...
![生产的线程依次put A、B、C三个值](http://cdn.passjava.cn/uPic/0658aa14cbde4b3c9585c9cef7ba3efb~tplv-k3u1fbpfcp-zoom-1SiuuQA.png)

- 消费线程使用take来消费阻塞队列中的内容，每次消费前，等待5秒

![消费线程每隔5s调用take方法](http://cdn.passjava.cn/uPic/e7365d5df751440991dcfb20919b6ab8~tplv-k3u1fbpfcp-zoom-1ZaXMxj.png)
...
![PriorityBlockQueue的原理图](http://cdn.passjava.cn/uPic/45d5fb5edf074e458e9a987b6bdc2d65~tplv-k3u1fbpfcp-zoom-1OI9TXG.png)
...
![DelayQueue原理图](http://cdn.passjava.cn/uPic/9b4788ebff69420c947ec20c6d94b047~tplv-k3u1fbpfcp-zoom-1WRWZsv.png)
...
![poll方法](http://cdn.passjava.cn/uPic/5e338fe4cf8f4572932023b152824395~tplv-k3u1fbpfcp-zoom-1mNGhDf.png)
