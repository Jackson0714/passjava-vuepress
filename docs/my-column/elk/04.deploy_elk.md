...
![](http://cdn.passjava.cn/uPic/image-20220429081629513SZNEjG.png)
...
![](http://cdn.passjava.cn/uPic/image-20220428174913552u88DfQ.png)
...
> Docker 方式详见这篇：http://http://old.passjava.cn/#/01.PassJava/03.Deploy/13.用Docker部署ELK
...
![](http://cdn.passjava.cn/uPic/image-20220427153256996VV8t1I.png)
...
![](http://cdn.passjava.cn/uPic/image-20220429073859697T6Mz4C.png)

Kibana 界面上会提示你是否导入样例数据，选一个后，Kibana 会帮你自动导入，然后就可以进入到 Discover 窗口搜索日志了。

![image-20220427161645270](http://cdn.passjava.cn/uPic/image-20220427161645270RXmlim.png)
...
![](http://cdn.passjava.cn/uPic/image-20220428143414718U0Scx1.png)
...
![](http://cdn.passjava.cn/uPic/20200507200319783-202204290737530803EExky.png)
...
![](http://cdn.passjava.cn/uPic/image-20220428143451668X0cdCb.png)

我们首先需要创建一个配置文件，配置内容如下图所示：

![](http://cdn.passjava.cn/uPic/image-20220428162630243dSLSIZ.png)
...
![](http://cdn.passjava.cn/uPic/image-20220428160151593f22799.png)
...
![](http://cdn.passjava.cn/uPic/image-20220429075432980li7dD0.png)
...
![](http://cdn.passjava.cn/uPic/image-20220428173005418B8pXdB.png)
...
![](http://cdn.passjava.cn/uPic/image-20220428180827001DYPqES.png)
...
![创建查询的索引](http://cdn.passjava.cn/uPic/image-20220428174049538Se2wKq.png)

![搜索日志](http://cdn.passjava.cn/uPic/image-20220428174301572q2qPN4.png)
...
![filebeat 只监测到了 info.log 文件](http://cdn.passjava.cn/uPic/image-20220428182901612I24wQE.png)

logstash 输出结果如下，会有格式化后的日志：

![](http://cdn.passjava.cn/uPic/image-20220428183109718WO54D2.png)

我们在 Kibana dev tools 中可以看到索引 apache_elastic_example，说明索引创建成功，日志也导入到了 elasticsearch 中。

![](http://cdn.passjava.cn/uPic/image-20220428182658722zuUSMW.png)

另外注意下 logstash 中的 grok 过滤器，指定的 message 的格式需要和自己的日志的格式相匹配，这样才能将我们的日志内容正确映射到 message 字段上。

例如我的 logback 的配置信息如下：

![logback 配置](http://cdn.passjava.cn/uPic/image-20220429074812538mfiKmb.png)
...
![](http://cdn.passjava.cn/uPic/image-20220428185455664vf7jWn.png)
