...
TCP MSS is an option in the TCP header that is used by the two ends of the connection _independently_ to determine the maximum segment size that can be accepted by each host on this connection.
