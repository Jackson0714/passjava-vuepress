---
title: 我用 Mac M1 玩转 Spring Cloud
category: 走近项目
tag:
  - passjava面试刷题项目
---
...
![](http://cdn.passjava.cn/blog/20200407/scg1XhlvGbUV.png?imageslim)

本文主要内容如下：

![](http://cdn.passjava.cn/uPic/image-20210419221858973.png)
...
![image-20210415202053473](http://cdn.passjava.cn/uPic/image-20210415202053473.png)
...
![](http://cdn.passjava.cn/uPic/image-20210415201228009.png)
...
![](http://cdn.passjava.cn/uPic/image-20210419221107351.png)
...
![](http://cdn.passjava.cn/uPic/image-20210415210949756.png)

新建命名空间时需要填写的字段：

![](http://cdn.passjava.cn/uPic/image-20210415223534157.png)
...
![](http://cdn.passjava.cn/uPic/image-20210415224144859.png)

### 1.5 添加 thirdparty 微服务配置

主要是配置阿里云 OSS，用来保存图片的。配置如下图所示，key 需要大家到自己登陆到阿里云并申请 OSS 才能获取到。参照这篇`《SpringCloud整合OSS对象存储》`。

![image-20210419211116806](http://cdn.passjava.cn/uPic/image-20210419211116806.png)
...
[参考链接](http://http://old.passjava.cn/#/05.%E5%AE%89%E8%A3%85%E9%83%A8%E7%BD%B2%E7%AF%87/09.M1%E8%BF%90%E8%A1%8CDocker?id=_41-%e4%b8%8b%e8%bd%bd-redis-%e9%95%9c%e5%83%8f)

### 2.2 下载和运行 ZipKin 镜像

[参考链接](http://http://old.passjava.cn/#/02.PassJava%E6%9E%B6%E6%9E%84%E7%AF%87/17.%E5%BE%AE%E6%9C%8D%E5%8A%A1%E6%9E%B6%E6%9E%84%E4%B8%AD%E7%9A%84%E9%93%BE%E8%B7%AF%E8%BF%BD%E8%B8%AA?id=_52-docker-%e5%ae%89%e8%a3%85-zipkin-%e6%9c%8d%e5%8a%a1)
...
![](http://cdn.passjava.cn/uPic/image-20210416171926892.png)

下载后点击安装，安装成功后，到系统偏好配置里面找到 MySQL，并单击打开。

![](http://cdn.passjava.cn/uPic/image-20210416172252026.png)

可以看到运行的 MySQL 实例是 MySQL 8.0.23，且默认开机运行。

![]![](http://cdn.passjava.cn/uPic/image-20210416172644156.png)
...
![](http://cdn.passjava.cn/uPic/UTOOLS-CLIPBOARD-1618565321940.png)

#### 2.2.2 Squel Pro 在 M1 上不能运行

2021.04 安装 Squel Pro 后，切换数据库的时候程序崩溃。

![image-20210416173839710](http://cdn.passjava.cn/uPic/image-20210416173839710.png)
...
![](http://cdn.passjava.cn/uPic/image-20210416183120950.png)
...
![](http://cdn.passjava.cn/uPic/image-20210416195132717.png)

依次执行上面的三个文件后，会生成 6 个数据库，一个系统数据库，五个业务数据库。

![](http://cdn.passjava.cn/uPic/image-20210416201245011.png)
...
![](http://cdn.passjava.cn/uPic/image-20210419212241925.png)
...
![](http://cdn.passjava.cn/uPic/image-20210417000630492.png)
...
![](http://cdn.passjava.cn/uPic/image-20210417003249707.png)
...
![](http://cdn.passjava.cn/uPic/image-20210419203630825.png)
...
![](http://cdn.passjava.cn/uPic/image-20210419204904998.png)

#### 3.4.2 启动题目服务

IDEA 工具中直接启动就可以了，暴露的端口是 11000，启动后如下图所示：

![](http://cdn.passjava.cn/uPic/image-20210419205109652.png)

#### 3.4.3 测试题目服务

用 postman 测试网关+题目微服务是否正常工作：

![](http://cdn.passjava.cn/uPic/image-20210419205816096.png)
...
![](http://cdn.passjava.cn/uPic/image-20210419212129883.png)
...
![](http://cdn.passjava.cn/uPic/image-20210416204951214.png)
...
![](http://cdn.passjava.cn/uPic/image-20210416211547660.png)
...
![](http://cdn.passjava.cn/uPic/image-20210416205116707.png)
...
![](http://cdn.passjava.cn/uPic/image-20210416211729789.png)
...
![](http://cdn.passjava.cn/uPic/image-20210416212055167.png)
...
![image-20210416224957858](http://cdn.passjava.cn/uPic/image-20210416224957858.png)
...
![](http://cdn.passjava.cn/uPic/image-20210416225210584.png)
...
![](http://cdn.passjava.cn/uPic/image-20210416225322860.png)
...
![PassJava后台](http://cdn.passjava.cn/uPic/DQDm4seRS85s.png)

### 4.6 添加题目分类

首先需要给题目进行分类，在后台点击新增类型，如下图所示：

![](http://cdn.passjava.cn/uPic/image-20210419215359713.png)

注意：上传图片前需要启动 thirdparty 微服务，且 OSS 配置正确。

### 4.7 添加面试题

![](http://cdn.passjava.cn/uPic/image-20210419220316407.png)
...
![](http://cdn.passjava.cn/uPic/image-20210417225617807.png)
...
![image-20220816213933082](http://cdn.passjava.cn/uPic/image-20220816213933082OTRNysdnaynh.png)
