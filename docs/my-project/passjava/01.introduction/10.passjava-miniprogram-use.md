...
本文主要内容如下：
![](http://cdn.passjava.cn/uPic/c1ef95d8cccc194b72a7688a0a32bfa9K7hPnr.png)
...
![](http://cdn.passjava.cn/uPic/5a55f92bf35abdb98ecfe528f307aac89ggYUQ.png)
...
![](http://cdn.passjava.cn/uPic/540a24d6907aeff93bc053385d1c4eb9qmJgmc.gif)
...
![题目类型](http://cdn.passjava.cn/uPic/bdeb3527ca89fe05f7505dc7c1411a21NtaJD1.png)

- 第二步：进入到题库列表页。下图是 Spring 题库列表页，可以点击查看进入到题目的详情页。

![Spring 题库](http://cdn.passjava.cn/uPic/ae9436f90577cf36f5944d9b14552e72e3D4UR4mXoj4.png)

- 第三步：进入到题目详情页。如下图所示就是 spring 面试题的详情页，加载的内容就是上传到云存储的 markdown 文件。后面会讲解如何上传题目。

![题目详情页](http://cdn.passjava.cn/uPic/f83181dc35b5b803568923ff2ff0acc5pGkldl.png)
...
![image-20210408155451254](http://cdn.passjava.cn/uPic/49bd12de1c695dcc2adf030119bd804bl43FGS.png)

#### 2.2.3 添加题目记录

然后需要在数据库中插入数据，来提供给小程序查询。

![](http://cdn.passjava.cn/uPic/5c4065288a393d200b7a3dc91098009cG1bI2b.png)
...
![共 12 种](http://cdn.passjava.cn/uPic/1258270a9f9bbcad347a4e65110ebbe3b5OGFE.png)
...
![](http://cdn.passjava.cn/uPic/image-20210411092400523.png)
...
![](http://cdn.passjava.cn/uPic/ec70fd21f373f2fd12d4add379c96df1RQUNKD.png)

- MySQL 数据库和表结构创建成功。

  数据库文件在 \data\sql 目录，需要都执行。执行成功后，业务表总共有 5 个业务模块， 7 张表，如下图所示：

![](http://cdn.passjava.cn/uPic/1e3cda87a301c17032766628c81aaecdZBtcTz.png)

- Nacos 服务启动成功且已配置好微服务的相关配置。

  如何配置可参考前面的文章。访问地址：http://192.168.56.1:8848/nacos。访问 Nacos，并登陆 Nacos 后，如下图所示：

![](http://cdn.passjava.cn/uPic/d7e843262d5a0b48504cf6e97890c76dfys4Hf.png)

- passjava-portal 管理控制台启动成功。

  通过 http://localhost:8001/ 访问。

![](http://cdn.passjava.cn/uPic/152288df8443882abc3742b28348da57qeq6NU.png)

- 题目管理功能正常使用。

  可以创建题目类型和创建题目。

![](http://cdn.passjava.cn/uPic/a78a5b4728d2726466e8685d5295a2cfwfPUxw.png)

- 打开小程序代码正常。

可以查询题目列表和查询题目的答案。

![](http://cdn.passjava.cn/uPic/Filmage%202022-11-01_232626bSpLUJfxaYJx.gif)
...
![](http://cdn.passjava.cn/uPic/image-20221101233245282L5ju0N.png)

#### 查询题目详情

代码路径：miniprogram/pages/javaQuestionDetail/javaQuestionDetail.js

![](http://cdn.passjava.cn/uPic/image-20221101233315920rpLzZv.png)
...
![](http://cdn.passjava.cn/uPic/image-20221101233539957ORXdSO.png)

#### 查询题目详情的 API

![](http://cdn.passjava.cn/uPic/image-20221101233558397xb0sIN.png)
...
![image-20221101233819567](http://cdn.passjava.cn/uPic/image-20221101233819567qgmgY8.png)

#### 题目类型数据

表：passjava_qms.qms_type

![](http://cdn.passjava.cn/uPic/image-20221101233849267LTWzNH.png)
