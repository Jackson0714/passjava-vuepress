---
title: 05｜协议实战（下）：通过 A2A，你的智能体不仅能对话还可以协作！
date: 2025-06-19
---
...
![](http://cdn.passjava.cn/uPic/image-202506191708567213lkMhR.png)

#### 各 Agent 详细说明

Agent Card 中的 Description 和 Skill 有对应的说明。

![](http://cdn.passjava.cn/uPic/image-20250619151947404ARqAkx.png)
...
![](http://cdn.passjava.cn/uPic/image-20250619155433014Cjn0FG.png)
...
![](http://cdn.passjava.cn/uPic/image-20250619163647902IvW51G.png)
...
![](http://cdn.passjava.cn/uPic/image-20250619164818042AlYVti.png)
...
![](http://cdn.passjava.cn/uPic/image-20250619165709894QFuJZl.png)
...
![](http://cdn.passjava.cn/uPic/image-202506191706376533fhnkY.png)
...
![image-20250619150659229](http://cdn.passjava.cn/uPic/image-20250619150659229JtVI6s.png)
...
![](http://cdn.passjava.cn/uPic/image-20250619171459930DPOTB1.png)

![](http://cdn.passjava.cn/uPic/image-20250619171439275p89oAC.png)
...
![image-20250619143836272](http://cdn.passjava.cn/uPic/image-202506191438362723KEVFe.png)

往下滑，会看到这个，点击进入“凭据”页面，就可以创建自己的 API 了。

![](http://cdn.passjava.cn/uPic/image-20250619143734769fJfbf4.png)

https://console.cloud.google.com/apis/credentials?hl=zh-cn&inv=1&invt=Ab0dTA&project=silicon-brace-463315-c5

![image-20250618234050599](http://cdn.passjava.cn/uPic/image-20250618234050599gAV2C0uqeRxC.png)
...
![image-20250618235541601](http://cdn.passjava.cn/uPic/image-20250618235541601SpDyxg.png)

启动完成。

![image-20250619000554344](http://cdn.passjava.cn/uPic/image-20250619000554344ootCTL.png)

### 403 Generative Language API has not been used

对话时，卡在 Working

![image-20250619001200343](http://cdn.passjava.cn/uPic/image-20250619001200343hdS3Qt.png)

host agent 报错信息如下：

![image-20250619001219131](http://cdn.passjava.cn/uPic/image-2025061900121913113mP2D.png)
...
![image-20250619001149395](http://cdn.passjava.cn/uPic/image-202506190011493953vrSx4.png)
...
![](http://cdn.passjava.cn/uPic/image-20250619001331505gT2gGO.png)
...
![image-20250619002013418](http://cdn.passjava.cn/uPic/image-202506190020134180r2jPG.png)

### 报错 Agent knowledge_agent not found

当我提问 比萨斜塔的倾斜角度问题时，AI 卡在 Working 状态。

![](http://cdn.passjava.cn/uPic/image-20250619091033457FaDIaJZVMsU9.png)
...
![](http://cdn.passjava.cn/uPic/image-20250619145547838UQvKmR.png)
...
![image-20250619092538139](http://cdn.passjava.cn/uPic/image-20250619092538139JGxUjmqWQcJx.png)
...
![](http://cdn.passjava.cn/uPic/image-20250619142739224ho0Jbl.png)
...
用 curl 或 postman 工具测试是否能访问

```SH
http://localhost:8028/v1/2025-07-08
```

![image-20250709133533462](http://cdn.passjava.cn/uPic/image-20250709133533462xrF2L3.png)

```SH
curl http://localhost:8028/v1/2025-07-08
```

![](http://cdn.passjava.cn/uPic/image-20250709133639984xpUcyo.png)
...
![image-20250619144948390](http://cdn.passjava.cn/uPic/image-2025061914494839032kbal.png)

汇率换算 Agent 的打印结果：

![image-20250619142240944](http://cdn.passjava.cn/uPic/image-2025061914224094439RiQ8.png)
...
![image-20250619091923344](http://cdn.passjava.cn/uPic/image-20250619091923344AUsygnUhTc5D.png)
...
![image-20250619091822483](http://cdn.passjava.cn/uPic/image-202506190918224830RoB9HF2Pfpv.png)

![](http://cdn.passjava.cn/uPic/image-2025061909203948657kaxj03LZbY.png)

![](http://cdn.passjava.cn/uPic/image-20250619092545627xTdvcr4lmr8Y.png)

汇率换算

![](http://cdn.passjava.cn/uPic/image-2025061914190239655Q48ZhtnIzC.png)

![image-20250619142235065](http://cdn.passjava.cn/uPic/image-20250619142235065d8E2OCJg8Vos.png)
