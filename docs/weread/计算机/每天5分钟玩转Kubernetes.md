...
那么问题来了：1.这几个节点是对等的，端口映射是自动的随机分配吗？2.主从复制的实例是否能通过这种方式?应该不能吧，有些配置是针对不同的节点类型的。3.是否能实现分片?比如启动了 3 个 ES 副本，怎么让它们组成集群模式且是分片的? - ⏱ 2022-05-31 06:32:19
