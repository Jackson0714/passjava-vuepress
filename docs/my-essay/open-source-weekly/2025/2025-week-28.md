...
![datax_why_new](http://cdn.passjava.cn/uPic/93b7fc1c-6927-11e6-8cda-7cf8420fc65for7zKs.png)
...
![datax_framework_new](http://cdn.passjava.cn/uPic/ec7e36f4-6927-11e6-8f5f-ffc43d6a468bL2GpOR.png)
...
![datax_arch](http://cdn.passjava.cn/uPic/aa6c95a8-6891-11e6-94b7-39f0ab5af3b4jshDrf.png)
...
- #### 极简的使用体验
  ...
  - 详细
    ...
    - 传输过程中打印传输速度、进度等
      ...
      [![datax_run_speed](http://cdn.passjava.cn/uPic/d1612c0a-6891-11e6-9970-d6693c15ef24UlBbYN.png)](https://cloud.githubusercontent.com/assets/1067175/17850877/d1612c0a-6891-11e6-9970-d6693c15ef24.png)

    - 传输过程中会打印进程相关的CPU、JVM等

      [![datax_run_cpu](http://cdn.passjava.cn/uPic/ee63c2fe-6891-11e6-9056-97d7e3d13d8dbJd8Hf.png)](https://cloud.githubusercontent.com/assets/1067175/17850903/ee63c2fe-6891-11e6-9056-97d7e3d13d8d.png)

    - 在任务结束之后，打印总体运行情况

      [![datax_end_info](http://cdn.passjava.cn/uPic/0484d3ac-6892-11e6-9c1d-b102ad210a32jLda3J.png)](https://cloud.githubusercontent.com/assets/1067175/17850930/0484d3ac-6892-11e6-9c1d-b102ad210a32.png)

## Nifi 数据同步

https://github.com/apache/nifi

简单的说，NiFi就是为了解决不同系统间数据自动流通问题而建立的。虽然dataflow这个术语在各种场景都有被使用，但我们在这里使用它来表示不同系统间的自动化的可管理的信息流。自企业拥有多个系统开始，一些系统会有数据生成，一些系统要消费数据，而不同系统之间数据的流通问题就出现了。这些问题出现的相应的解决方案已经被广泛的研究和讨论，其中企业集成[eip](https://nifichina.github.io/1-基础文档/1-Overview.html#eip)就是一个全面且易于使用的方案。

### NiFi架构

![img](http://cdn.passjava.cn/uPic/zero-master-node.a1badfaaGInoFP.png)

官方文档：https://nifi.apache.org/components/

Nifi 中文文档：https://nifichina.github.io/
