...
![](http://cdn.jayh.club/uPic/640F7q9Vz.png)
...
![](http://cdn.jayh.club/uPic/image-20250510214106063vvHzSD.png)

然后在 MCP 市场搜索 EdgeOne Pages，就能找到对应的 MCP 服务，点击安装即可。如下图所示：

![](http://cdn.jayh.club/uPic/image-20250510214236658Gb5kp0.png)

安装完成后，会在一个 Json 配置文件中生成 EdgeOne Page MCP Server 的配置。

![](http://cdn.jayh.club/uPic/image-20250510214329762sP3H5N.png)
...
![](http://cdn.jayh.club/uPic/image-202505102207474386pU4Vf.png)
...
![](http://cdn.jayh.club/uPic/image-20250510221128174T79goX.png)

在本地可以看到生成的 html、js、css 文件，如下图所示：2![](http://cdn.jayh.club/uPic/image-202505102210462454dlUNe.png)

### 自动部署游戏到公网

CodeBuddy 自动调用 EdgeOne Pages MCP Server 服务，将代码上传了EdgeOne Pages 服务器上，并返回了公网 URL。

![image-20250510221305000](http://cdn.jayh.club/uPic/image-20250510221305000Q1SYCW.png)

打开2048 游戏链接，就可以开始游戏了。

![](http://cdn.jayh.club/uPic/image-20250510221457315Vda1Cb.png)
...
![](http://cdn.jayh.club/uPic/image-20250510221748335uU3j1R.png)

现在可以畅玩 2048 游戏了。

![](http://cdn.jayh.club/uPic/image-20250510221923618pZ0TQ6.png)
