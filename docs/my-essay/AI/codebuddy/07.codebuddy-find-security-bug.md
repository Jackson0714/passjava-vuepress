...
![](http://cdn.jayh.club/top/202505131516404.png)
...
![](http://cdn.jayh.club/top/202505131516904.png)
...
![](http://cdn.jayh.club/top/202505131518369.png)

### 3.2 分析 SQL 注入漏洞

这次我们重点来分析 SQL 注入漏洞。CodeBuddy 找到这一段代码是有问题的。

![](http://cdn.jayh.club/top/202505131733879.png)
...
![](http://cdn.jayh.club/top/202505131622459.png)
...
![](http://cdn.jayh.club/uPic/image-202505132100594979K3f3I.png)
...
![](http://cdn.jayh.club/uPic/image-20250513204854165zXGqK0.png)
...
![](http://cdn.jayh.club/uPic/image-20250513210202914xk9iZI.png)
...
![](http://cdn.jayh.club/uPic/image-202505132112494909rXNMw.png)
...
![](http://cdn.jayh.club/uPic/image-20250513211609042yhJpga.png)

#### 4.3.2 模拟黑客攻击

在众测阶段，产线会提前分配账号给大家登录测试，有测试同学登录后，用 postman 工具调用了一个保存请求，将 logo 存储为非正常图片的 base64 编码（注入了恶意的代码）。如下图所示：

![](http://cdn.jayh.club/uPic/image-20250513210606995pplO1R.png)
...
![](http://cdn.jayh.club/uPic/image-20250513220443824uwpV5a.png)

用户访问主页时，浏览器会从 Web 服务器获取 logo 的图片数据，然后组装到 HTML 中，如下图所示：

![image-20250513211657276](http://cdn.jayh.club/uPic/image-20250513211657276u3fUGU.png)

最后用户看到的将是这个页面。

![](http://cdn.jayh.club/uPic/image-20250513212044384WlV6lT.png)

鼠标右键点击test 左侧的图标，选择“在新标签页中打开图片”。

![](http://cdn.jayh.club/uPic/image-20250513212144944HNnw4j.png)

接着就会出现一个弹框，弹出了一个数字 1，表示 XSS 攻击成功了。

![](http://cdn.jayh.club/uPic/image-20250513212259441j9GTky.png)
...
![](http://cdn.jayh.club/uPic/image-2025051321444105295tEeE.png)

修复方案如下：

![](http://cdn.jayh.club/uPic/image-20250513214540356rewIW7.png)
...
![](http://cdn.jayh.club/uPic/image-20250513214851690DqlYrn.png)
