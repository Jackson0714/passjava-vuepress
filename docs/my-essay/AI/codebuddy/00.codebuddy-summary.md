...
![](http://cdn.jayh.club/uPic/image-20250510102848420RMKECI91wAtv.png)

CodeBuddy 它其实不知道你要分析哪个文件。必须提供文件路径才行，希望 CodeBuddy 官方可以优化下这个工具~

那我们还是提供一个文件路径，再次提问，我直接给了一个文件名 exam.vue，并不是一个文件路径。如下图所示：

![](http://cdn.jayh.club/uPic/image-20250510103027357CDKTOYwrcMAT.png)

CodeBuddy 还会用 read_file 工具来读取 exam.vue 文件，然后告诉我读取失败，我以为这就完了，没想到它还是遍历整个文件工程，太炫酷了！

![](http://cdn.jayh.club/uPic/image-20250510103200659fPqSorokw6pu.png)

经过5次遍历查找，终于找到了 exam.vue 文件。如下图所示：

![](http://cdn.jayh.club/uPic/image-20250510103420966KvRKVBmlnTgw.png)

### 开始分析文件

CodeBuddy 开始分析 exam.vue 文件中的问题。

![](http://cdn.jayh.club/uPic/image-20250510103731945LBPsgFCsKMXH.png)

然后可以选择让 CodeBuddy 自动添加代码注释，还是用询问的方式，这里直接选择自动方式。

CodeBuddy 就会自动一步步添加注释。如下图所示：

![](http://cdn.jayh.club/uPic/image-20250510103914998LnSN9Pzoc7qA.png)

还可以查看每一步变更的内容，如下图所示：

![](http://cdn.jayh.club/uPic/image-20250510104000036thrqm1T5OSiq.png)

最后 CodeBuddy 会总结修改了哪些内容，还是很贴心的。如下图所示：

![](http://cdn.jayh.club/uPic/image-202505101042054854nZknPT36tGS.png)

### 查看变更

我们通过 Git Diff 来查看文件变更内容，如下图所示：

![](http://cdn.jayh.club/uPic/image-20250510104423795XwmqMueUVjVcfqeTB5.png)
...
![img](http://cdn.jayh.club/uPic/b6b91217dba241dbe7062a5caf222c2coDybBmUiq64f.png)

安装 CodyBuddy 插件，安装完成后如下图所示：

![img](http://cdn.jayh.club/uPic/dbcaec2f4d57801b1a06521e48d6167bdJJFwBORPKWL.png)
...
![img](http://cdn.jayh.club/uPic/64efd83be4b551958ed8b0ddab96566bVuLXXJ6cVXxC.png)
...
![img](http://cdn.jayh.club/uPic/0bbc197d1c1d3177f1aaf0053a8e33d9ax0WInsJEGsV.png)
...
![](http://cdn.jayh.club/uPic/image-20250510153110754CwC2NR7QMlwY.png)
...
![图片](http://cdn.jayh.club/uPic/640TwAIH88zE1Xk.jpg)
...
![](http://cdn.jayh.club/uPic/image-20250510153609761My0MWSKXtcXT.png)
...
![](http://cdn.jayh.club/uPic/image-20250510154418160wrmPrFmV1ZXM.png)

然后在 MCP Server 中添加 EdgeOne Pages MCP Server

![](http://cdn.jayh.club/uPic/image-20250510154540440xYYs7zBuKqKb.png)

然后点击它的开始按钮，如下图所示：

![](http://cdn.jayh.club/uPic/image-202505101546354427XCLL6jYvmnm.png)
...
![](http://cdn.jayh.club/uPic/image-20250510154824282jfqKYtlV9WYp.png)

我们直接访问这个公网 URL，打开的页面内容包含一个简单的标题和段落文本，如下图所示：

![](http://cdn.jayh.club/uPic/image-20250510155113157VCeulKybAlu5.png)
...
![](http://cdn.jayh.club/uPic/640F7q9Vzpizzim.png)
...
![](http://cdn.jayh.club/uPic/image-20250510214106063vvHzSDlRsz9g.png)

然后在 MCP 市场搜索 EdgeOne Pages，就能找到对应的 MCP 服务，点击安装即可。如下图所示：

![](http://cdn.jayh.club/uPic/image-20250510214236658Gb5kp093WDLq.png)

安装完成后，会在一个 Json 配置文件中生成 EdgeOne Page MCP Server 的配置。

![](http://cdn.jayh.club/uPic/image-20250510214329762sP3H5N2uQ3HJ.png)
...
![](http://cdn.jayh.club/uPic/image-202505102207474386pU4VfCyjClI.png)
...
![](http://cdn.jayh.club/uPic/image-20250510221128174T79goXvQphG7.png)

在本地可以看到生成的 html、js、css 文件，如下图所示：2![](http://cdn.jayh.club/uPic/image-202505102210462454dlUNeW3PVBX.png)

### 自动部署游戏到公网

CodeBuddy 自动调用 EdgeOne Pages MCP Server 服务，将代码上传了EdgeOne Pages 服务器上，并返回了公网 URL。

![image-20250510221305000](http://cdn.jayh.club/uPic/image-20250510221305000Q1SYCWMghYQe.png)

打开2048 游戏链接，就可以开始游戏了。

![](http://cdn.jayh.club/uPic/image-20250510221457315Vda1Cbm1xJwW.png)
...
![](http://cdn.jayh.club/uPic/image-20250510221748335uU3j1R5Fkl04.png)

现在可以畅玩 2048 游戏了。

![](http://cdn.jayh.club/uPic/image-20250510221923618pZ0TQ62pSJvP.png)
...
![](http://cdn.jayh.club/uPic/image-20250511130755202btrJbs.png)
...
![](http://cdn.jayh.club/uPic/image-20250511154919255c64kT0.png)

然后 CodeBuddy 就会自动生成代码文件。如下图所示：

![](http://cdn.jayh.club/uPic/image-20250511154813999NyC2Gv.png)

然后 CodeBuddy 会将这个 HTML 文件部署到 Web 网站。CodeBuddy 调用 EdgeOne Pages 服务部署时，第一次失败了，接着它还会重试。

![](http://cdn.jayh.club/uPic/image-20250511155205397La9M4o.png)

CodeBuddy 会将网站的地址显示在对话框中，如下图所示：

![](http://cdn.jayh.club/uPic/image-20250511155330066PKDYgI.png)
...
![](http://cdn.jayh.club/uPic/image-202505111546569759xnHCe.png)
...
![](http://cdn.jayh.club/uPic/540a24d6907aeff93bc053385d1c4eb9qmJgmcD7sl9M.gif)
...
![](http://cdn.jayh.club/uPic/image-20250511195825918ZQjJ7n.png)

## 生成一个小程序模版

现在微信开发者工具在创建项目的时候，可以选择很多模版，有功能简单的，也有功能复杂的比如电商小程序。如下图所示：

![](http://cdn.jayh.club/uPic/image-20250512195448730aHMTny.png)

这次我们选择一个最简单的模版，看看 CodeBuddy 能帮我们做到什么程度。如下图所示，只有一个获取头像和昵称的界面。

![](http://cdn.jayh.club/uPic/image-202505120948039208BOr1z.png)
...
![image-20250512202349136](http://cdn.jayh.club/uPic/image-202505122023491368N05Oq2BZ4Oy.png)
...
![](http://cdn.jayh.club/uPic/image-20250512202601379zNE7Xo.png)

了解这些信息后，CodeBuddy 就可以制定一个更加详细的改造计划。等个几分钟后，所有的代码都会生成完成，如下图所示：

![](http://cdn.jayh.club/uPic/image-20250512202915330z0ip42.png)
...
![](http://cdn.jayh.club/uPic/image-20250512105017917ojGpxy.png)

那我们手动来微调下首页的样式，其他也比较简单。最后效果如下：

![](http://cdn.jayh.club/uPic/image-20250512203547092bSgOxL.png)
